...
if ($status=="BLOCK"){
echo "Sorry, your site was blocked. Please contact administrator..";
header("Location: http://$from");
die();} 

if ($status==""){
echo "Sorry the marketing site indicated to be cheating..";
header("Location: http://$from");
die();} 
?>
<script>
...
<div class="form_pendaftaran">	
				...
				4. Membayar segala bentuk pembayaran hanya melalui nmr rekening resmi Bank BRI  0098-01-002137-30-3 an PSPP Penerbangan. <br>Dan dengan ini anda menyatakan bahwa data yang anda isikan pada Formulir Pendaftaran ini adalah benar adanya dan anda memberikan ijin kepada PSPP (Pendidikan Staff Penerbangan & Pramugari) untuk mengolah data tersebut untuk keperluan pendaftaran program pendidikan yang diselenggarakan oleh PSPP Penerbangan. <br>
</p>
...
<label>NPSN (Nomor Pokok Sekolah Nasional)  :</label> <input value="<? echo $b[90];?>" name="npsn" class="input_field" readonly onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">
...
<label>Jenjang:</label> <input value="<? echo $b[87];?>" name="jenjang_sekolah"  readonly onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">

<label>Kota/Kab :</label> <input value="<? echo $b[88];?>" name="kota_sekolah" readonly onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">

<label>Provinsi :</label> <input value="<? echo $b[89];?>" name="provinsi_sekolah" readonly onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">
