...
Config::$serverKey = 'SB-Mid-server-5coNcjgSJpaaXPv3eyJxqL6F';
include "../../koneksi.php";
...
{
mysqli_query($koneksi, "update pembayaran set status = '3' where order_id = '$order_id'");
}
else if ($transaction == 'pending') {
    mysqli_query($koneksi, "update pembayaran set status = '2' where order_id = '$order_id'");
}
...
function printExampleWarningMessage() {
    ...
    if (strpos(Config::$serverKey, 'your ') != false ) {
        ...
        echo "<br>";
        echo "<br>";
        echo htmlspecialchars('Config::$serverKey = \'SB-Mid-server-5coNcjgSJpaaXPv3eyJxqL6F\';');
        die();
    }   
}
