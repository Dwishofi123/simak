...
function PrintDiv13() {    
	...
	function BoxTambah(){
        $.colorbox({iframe:true, width:"89%", height:"90%", href: "system/acc_kas_masuk_form.php"});
      }
 ...
 <div class="col-md-10"> <div class="head bg-default bg-light-ltr np"> 
	 <div class="head bg-default bg-light"> <h2>Jurnal Kas Masuk <? echo $_SESSION[unit];?></h2> </div> 			 
 <div class="block"> <div class="head bg-default bg-light-ltr np"> <ul class="nav nav-tabs pull-left"> 
 <li><a href="#tab13" onClick='getPage(34)' data-toggle="tab"><i class="icon-css3"></i> Kas Keluar</a></li> 
 <li class="active"><a href="#tab13" onClick='getPage(35)' data-toggle="tab"><i class="icon-css3"></i> Kas Masuk</a></li> 
 ...
 <div class="tab-pane active">
	   ...
	   <div class=btn-group>
   <a href=#tambah_jurnal onClick='BoxTambah()' data-toggle=modal ><button class="btn btn-default btn-clean tip"  data-original-title="Tambah data baru"> Tambah Transaksi Kas Masuk</button></a>
   <a href="#" onClick='getPage(35)' ><button data-loading-text="Loading..."  id="fat-btn" class="btn btn-default btn-clean tip"  data-original-title="Refresh">Refresh</button> </a> 
