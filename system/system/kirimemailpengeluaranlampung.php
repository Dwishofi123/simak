...
$message=$message. "Laporan Pengeluaran Harian Keuangan <strong>PSPP Lampung</strong> tanggal $tgl<br><table  cellpadding=0 cellspacing=0 width=100% style='text-align:left;'> <thead> 
...
for ($x = 0; $x <= 1; $x++) { 
if ($x==0){ $to="thiqha.oktika@gmail.com"; }
