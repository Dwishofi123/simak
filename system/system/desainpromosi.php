 <script type=text/javascript src=../js/plugins/jquery/jquery-migrate.min.js></script> <script type=text/javascript src=../js/plugins/jquery/globalize.js></script> <script type=text/javascript src=../js/plugins/bootstrap/bootstrap.min.js></script> <script type=text/javascript src=../js/plugins/fancybox/jquery.fancybox.pack.js></script> <script type=text/javascript src=../js/plugins/uniform/jquery.uniform.min.js></script>  <script type=text/javascript src=../js/plugins/jquery/jquery.min.js></script> <script type=text/javascript src=../js/plugins/jquery/jquery-ui.min.js></script>

 <? include "konek.php";
 mysql_query("insert into tbl_log(datetime,uraian)value('$tanggal','$_SESSION[nama_login] membuka halaman desain promosi')");?>
 <div class=col-md-9> 
 <div class="block block-transparent"> 
 <div class=header> <h2>Free Download Desain Promosi PSPP Penerbangan</h2> 
 <div class="content gallery">
 <div class=row> <div class=col-md-12> <div class="alert alert-info"> <b>Hello...</b> Desain promo2 PSPP akan selalu kami perbarui per tanggal 1 dan tgl 15 disetiap bulannya loh.. Tunggu desain kami selanjutnya ya... happy download...<button type=button class=close data-dismiss=alert>×</button> </div> </div> </div>
