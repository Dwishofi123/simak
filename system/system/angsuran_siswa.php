...
function PrintDiv13() {    
	...
	function getTable(id) {
		...
		jQuery.ajax({
			url: "system/angsuran_siswa_table.php",
			data:'id='+id,
			type: "POST",
...
function ViewAngsuran(id){
	  ...
	  function BayarAngsuran(id){
        $.colorbox({iframe:true, width:"800", height:"100%", href: "system/bayar_siswa.php?id="+id});
      }
    </script>
 ...
 <div class="tab-pane active">
   ...
   <a href="#" onClick='getPage(16)' ><button data-loading-text="Loading..."  id="fat-btn" class="btn btn-default btn-clean tip"  data-original-title="Refresh">Refresh</button> </a> 
