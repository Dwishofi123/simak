...
function PrintDiv13() {    
	...
	function BoxTambah(){
        $.colorbox({iframe:true, width:"89%", height:"90%", href: "system/acc_umum_form.php"});
      }
 ...
 <li class="active"><a href="#tab13" onClick='getPage(33)' data-toggle="tab"><i class="icon-css3"></i> Kas Keluar</a></li> 
 <li><a href="#tab13" onClick='getPage(33)' data-toggle="tab"><i class="icon-css3"></i> Kas Masuk</a></li> 
 <li><a href="#tab13" onClick='getPage(33)' data-toggle="tab"><i class="icon-css3"></i> Jurnal Umum</a></li> 
 <li><a href="#tab13" onClick='getPage(33)' data-toggle="tab"><i class="icon-css3"></i> Export Laporan Mingguan</a></li> 
 </ul> </div> <div class="content tab-content bg-dot50">

 <div class="tab-pane active">

	   <div class=btn-group>
   <a href=#tambah_jurnal onClick='BoxTambah()' data-toggle=modal ><button class="btn btn-default btn-clean tip"  data-original-title="Tambah data baru"> Tambah Transaksi</button></a>
   <a href="#" onClick='getPage(33)' ><button data-loading-text="Loading..."  id="fat-btn" class="btn btn-default btn-clean tip"  data-original-title="Refresh">Refresh</button> </a> 
	...
	<br><br>
		...
		<!-- TABLE -->  <div id="tab13"> <div id="divToPrint13"><p>
		 <div id="tables" align=left>
			...
			$query=mysql_query("select * from kas_kecil where id_admin='$_SESSION[id_login]' and tanggal_transaksi='$tanggal'");
