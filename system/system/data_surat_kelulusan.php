...
function PrintDiv13() {    
	...
	function getTable(id) {
		...
		jQuery.ajax({
			url: "system/data_surat_kelulusan_table.php",
			data:'id='+id,
			type: "POST",
	...
	kelas = kelasValue.value;
		$('#tables').html("<img src='img/big_loading.gif'/><font color=white> <br>Loading... Mohon tunggu..</font>");
		jQuery.ajax({
			url: "system/data_surat_kelulusan_table.php?kelas="+kelas,
			data:'kelas='+kelas,
			type: "POST",
			success:function(data){$('#tables').html(data);}
		});
 ...
 <div class="head bg-default bg-light"> <h2>Cetak Surat Hasil Tes Seleksi / Kwitansi Daftar Ulang</h2> </div> 				 
