...
if ($halaman=="1"){?>
	<table border=1  class="table table-bordered table-striped table-hover"  cellpadding=0 cellspacing=0 width=100% style="text-align:left;" > <thead> 
			...
			$a=$a+1;?>
			<tr>   <td><? echo $a; ?></td> <td><? echo $b[1];?></td> <td><? echo $b[2];?> &nbsp;<a href="#hapus" onClick=BoxDelete(<? echo $b[0];?>)  data-title="Konfirmasi Hapus"  class="modal-ajax tip" data-original-title="Hapus"><span class="icon-trash"></span></a> &nbsp;</td>  <td><? $hp = substr("$b[4]", 0, -2); echo $hp."xx";?></td> <td><? $hp = substr("$b[5]", 0, -2); echo $hp."xx";?></td><td><? echo $b[6];?></td><td><? echo $b[10];?></td><td><? echo $b[11];?></td></tr> <? }?> 
	</tbody> </table> 
<? } elseif ($halaman=="2"){?>
		 ...
		 <div class="bg-default bg-light"><h2> Kampus <? echo $kampus." ".$jurusan;?></h2></div>
		  <table border=1 class="table table-bordered table-striped table-hover"  cellpadding=0 cellspacing=0 width=100% style="text-align:left;" > <thead> 
		...
		$a=$a+1;  ?>
		<tr>   <td><? echo $a; ?></td> <td><? echo $b[1];?></td> <td><? echo $b[2];?> &nbsp;<a href="#hapus" onClick=BoxDelete(<? echo $b[0];?>)  data-title="Konfirmasi Hapus"  class="modal-ajax tip" data-original-title="Hapus"><span class="icon-trash"></span></a> &nbsp;</td> <td><? echo $b[3];?></td> <td><? $hp = substr("$b[4]", 0, -2); echo $hp."xx";?></td> <td><? $hp = substr("$b[4]", 0, -2); echo $hp."xx";?></td><td><? echo $b[6];?></td></tr> 
		<?} ?> 
		 </tbody> </table> 
		<br>
		 <br><br>
...
<?} elseif ($halaman=="4"){?>
			...
			$a=$a+1;  ?>
			<tr>   <td><? echo $a; ?></td> <td><? echo $b[1];?></td> <td><? echo $b[2];?> &nbsp;<a href="#hapus" onClick=BoxDelete(<? echo $b[0];?>)  data-title="Konfirmasi Hapus"  class="modal-ajax tip" data-original-title="Hapus"><span class="icon-trash"></span></a> &nbsp;</td>  <td><? $hp = substr("$b[4]", 0, -2); echo $hp."xx";?></td> <td><? $hp = substr("$b[4]", 0, -2); echo $hp."xx";?></td><td><? echo $b[6];?></td><td><? echo $b[10];?></td><td><? echo $b[11];?></td></tr>
			<?} ?> 
			 </tbody> </table> <br><br><br>
