...
function PrintDiv13() {    
	...
	kelas = kelasValue.value;
		$('#tables').html("<img src='img/big_loading.gif'/><font color=white> <br>Loading... Mohon tunggu..</font>");
		jQuery.ajax({
			url: "system/migrasi_table.php?kelas="+kelas,
			data:'kelas='+kelas,
			type: "POST",
			success:function(data){$('#tables').html(data);}
		});
	  ...
	  function BoxEdit(id){
        $.colorbox({iframe:true, width:"80%", height:"80%", href: "system/migrasi_siswa_edit.php?id="+id});
      }
 ...
 <div class="head bg-default bg-light"> <h2>Migrasi Data Siswa Antar Marketing </h2> </div> 				 
 ...
 <div class="tab-pane active">
   ...
   <a href="#" onClick='getPage(3)' ><button data-loading-text="Loading..."  id="fat-btn" class="btn btn-default btn-clean tip"  data-original-title="Refresh">Refresh</button> </a> 
