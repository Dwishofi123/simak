...
function PrintDiv13() {    
	...
	function getTable(id) {
		...
		jQuery.ajax({
			url: "system/siswa_kerja_table.php",
			data:'id='+id,
			type: "POST",
	...
	ang = angValue.value;
		...
		$('#tables').html("<img src='img/big_loading.gif'/><font color=white> <br>Loading... Mohon tunggu..</font>");
		jQuery.ajax({
			url: "system/siswa_kerja_table.php?kelas="+kelas+"&angkatan="+ang,
	 ...
	 function BoxEdit(id){
        $.colorbox({iframe:true, width:"50%", height:"80%", href: "system/siswa_kerja_edit.php?id="+id});
      }
 ...
 <div class="head bg-default bg-light"> <h2>Data Siswa Bekerja </h2> </div> 				 
 ...
 <div class="tab-pane active">
   ...
   <a href="#" onClick='getPage(41)' ><button data-loading-text="Loading..."  id="fat-btn" class="btn btn-default btn-clean tip"  data-original-title="Refresh">Refresh</button> </a> 
