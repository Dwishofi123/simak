...
{
$psb_aktif="and jurusan like '%$b[jurusan]%' "; 
$text_psb_aktif=$b[jurusan]; 
$_SESSION['psb.aktif']=$b[jurusan];}?>
...
function PrintDiv13() {    
	...
	function getTable(id) {
		...
		jQuery.ajax({
			url: "system/data_siswa_marketing_table.php",
			data:'id='+id,
			type: "POST",
	...
	kelas = kelasValue.value;
		$('#tables').html("<img src='img/big_loading.gif'/><font color=white> <br>Loading... Mohon tunggu..</font>");
		jQuery.ajax({
			url: "system/data_siswa_marketing_table.php?kelas="+kelas,
			data:'kelas='+kelas,
			type: "POST",
			success:function(data){$('#tables').html(data);}
		});
