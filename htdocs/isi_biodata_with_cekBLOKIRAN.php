...
$query = mysql_query("select * from domain where domain='$_GET[from]'");	while($b=mysql_fetch_row($query)){$status=$b[3];}
if ($status=="BLOCK"){
header("Location: http://$from");
die();}?>
...
<div class="form_pendaftaran">	
					...
					<div class="post-content"> <p><strong>Terms & Conditions</strong><br>Isikan pendaftaran ini dengan benar. Dengan menekan tombol 'DAFTAR' berarti anda 
				menyatakan bahwa anda tidak buta warna, tinggi anda tidak kurang dari 157cm, tidak mempunyai riwayat penyakit hepatitis dan tidak bersedia membayar segala bentuk pembayaran kecuali ke nomor rekening resmi PSPP Penerbangan. Dan dengan ini anda menyatakan bahwa data yang anda isikan pada Formulir Pendaftaran ini adalah benar adanya dan anda memberikan ijin kepada PSPP (Pendidikan Staff Penerbangan & Pramugari) untuk mengolah data tersebut untuk keperluan pendaftaran program pendidikan yang diselenggarakan oleh PSPP Penerbangan. <br>
</p>
...
<label>Identitas Diri yg Masih Berlaku (KTP/Kartu Pelajar)  : <a href="uploads/cover-raport-<? echo $_GET[id];?>.jpg" target="_blank"><img src="uploads/cover-raport-<? echo $_GET[id];?>.jpg" class="resizedimages"></a></label>
...
<label>Nama lengkap : (nama lengkap harus sama dengan nama di kartu identitas yang masih berlaku (KTP/Kartu Pelajar). apabila nama tidak sama dengan raport maka tidak diprosses)</label> <input value="<? echo $b[2];?>" name="nama" placeholder="Nama lengkap" class="input_field" onfocus="this.placeholder = '' " type="text"  onBlur="javascript:{this.value = this.value.toUpperCase();}" >
...
<br><br>
<h2>Pendidikan</h2><br>
<label>Asal Sekolah  :</label> <input value="<? echo $b[6];?>" name="nama_sma" class="input_field" readonly onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">
<label>Alamat Sekolah :</label> <input value="<? echo $b[73];?>" name="alamat_sma" placeholder="Contoh : Jl. Gading Rejo No.09 Jakarta"  readonly onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">

<label>Jenjang:</label> <input value="<? echo $b[88];?>" name="jenjang_sekolah"  readonly onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">

<label>Kota/Kab :</label> <input value="<? echo $b[89];?>" name="kota_sekolah" readonly onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">

<label>Provinsi :</label> <input value="<? echo $b[90];?>" name="provinsi_sekolah" readonly onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text">
...
<div class="form_pendaftaran">	
					...
					<div class="post-content"> <p>Isikan pendaftaran ini dengan benar. Dengan menekan tombol 'DAFTAR' berarti anda 
				menyatakan bahwa anda tidak buta warna, tinggi anda tidak kurang dari 157cm, tidak mempunyai riwayat penyakit hepatitis dan tidak bersedia membayar segala bentuk pembayaran kecuali ke nomor rekening resmi PSPP Penerbangan. Dan dengan ini anda menyatakan bahwa data yang anda isikan pada Formulir Pendaftaran ini adalah benar adanya dan anda memberikan ijin kepada PSPP (Pendidikan Staff Penerbangan & Pramugari) untuk mengolah data tersebut untuk keperluan pendaftaran program pendidikan yang diselenggarakan oleh PSPP Penerbangan. <br>
					</div>
</p>
...
<h2>Biodata Diri</h2><br>
<label>Nama lengkap : (nama lengkap harus sama dengan nama di kartu identitas yang masih berlaku (KTP/Kartu Pelajar). apabila nama tidak sama dengan raport maka tidak diprosses)</label> <input name="nama" placeholder="Nama lengkap" class="input_field" onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}" type="text" >
...
<label>Nama Sekolah : (pilih <strong onfocus="suggest(this.value);">Kota Pendidikan</strong> untuk mengganti asal sekolah)</label>   <input  name="nama_sma"  onBlur="fill2();" readonly id="kode" class="input_field"   type="text" >
...
<label>Apakah sebelumnya anda sudah pernah menghubungi tim promosi kami? Apabila sudah, silakan uraikan disini.</label> <textarea name="uraianpromosi" placeholder="Contoh : saya sudah pernah menghubungi kak bejo PSPP sebelum mengisi biodata ini"  onfocus="this.placeholder = '' " onBlur="javascript:{this.value = this.value.toUpperCase();}"></textarea>
					...
					<div class="post-content"> <p><strong>Terms & Conditions</strong><br>Isikan pendaftaran ini dengan benar. Dengan menekan tombol 'DAFTAR' berarti anda 
				menyatakan bahwa anda tidak buta warna, tinggi anda tidak kurang dari 157cm, tidak mempunyai riwayat penyakit hepatitis dan tidak bersedia membayar segala bentuk pembayaran kecuali ke nomor rekening resmi PSPP Penerbangan. Dan dengan ini anda menyatakan bahwa data yang anda isikan pada Formulir Pendaftaran ini adalah benar adanya dan anda memberikan ijin kepada PSPP (Pendidikan Staff Penerbangan & Pramugari) untuk mengolah data tersebut untuk keperluan pendaftaran program pendidikan yang diselenggarakan oleh PSPP Penerbangan. <br>
					<i>Catatan : PSPP (Pendidikan Staff Penerbangan dan Pramugari) tidak pernah memberikan jaminan pekerjaan bagi peserta pendidikan. Terima kasih</i><br><br></div>
</p>
